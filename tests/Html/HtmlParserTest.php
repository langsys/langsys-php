...
class HtmlParserTest extends TestCase
{
     ...
     * (`86871033:tests/fixtures/canonicalization-reference.json`, blob
     * `fc4bb6efa7826a37f83ca6f8f7764e88370232d9`, 32 rows). Each row carries every
    ...
    public function testSourcesWriteInvisibleCharactersAsEscapes($path, $blob): void
    {
        $vendored = [
            ...
            // at langsys-js-typescript 86871033 (blob fc4bb6ef), which is escaped at source.

...
class HtmlParserTest extends TestCase
{
     ...
     * (`2d57cdd9:tests/fixtures/canonicalization-reference.json`, blob
     * `cae284dfd6d291ab7f95b2f620f0c0b189362829`, 32 rows). Each row carries every
    ...
    public function testSourcesWriteInvisibleCharactersAsEscapes($path, $blob): void
    {
        $vendored = [
            ...
            // at langsys-js-typescript 2d57cdd9 (blob cae284df), which is escaped at source.

...
Spec version implemented: **spec blob `5c5c0723`** (`langsys2` @ `5cff03a1`, spec 8.0.1,
**committed and deliberately unpublished**; derived 2026-09-12T23:31:34Z via
`git rev-parse 5cff03a17751e7dae9dcf1af52a9454d027c9006:docs/sdk-spec.mdx`)
...
**Grades, and what green means here.** One table, one rule id per row, all 79. Each row carries one
...
#
# Last run 2026-09-13T01:13:30Z against blob 5c5c0723 (langsys2 @ 5cff03a1): exit 0.
#

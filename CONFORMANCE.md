...
and HINT-9 as unassessed and the file as written against spec v6. All 45 binding rules
are now rowed against spec blob `06ae105a` (GATE-7 at line 33, WIRE-5 at line 108;
BIND-1…6 and HINT-9 do not bind a server core). Left in place, it would have understated
this file's coverage to the next reader — the opposite of the failure it exists to
prevent, and no less wrong.
